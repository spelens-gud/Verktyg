...
type Definitions map[string]*JsSchema
...
type JsSchema struct {
	...
	AdditionalItems      *JsSchema            `json:"additionalItems,omitempty"`      // section 5.9
	Items                *JsSchema            `json:"items,omitempty"`                // section 5.9
	...
	PatternProperties    Definitions          `json:"patternProperties,omitempty"`    // section 5.17
	AdditionalProperties json.RawMessage      `json:"additionalProperties,omitempty"` // section 5.18
	Dependencies         map[string]*JsSchema `json:"dependencies,omitempty"`         // section 5.19
	Enum                 []interface{}        `json:"enum,omitempty"`                 // section 5.20
	Type                 string               `json:"type,omitempty"`                 // section 5.21
	AllOf                []*JsSchema          `json:"allOf,omitempty"`                // section 5.22
	AnyOf                []*JsSchema          `json:"anyOf,omitempty"`                // section 5.23
	OneOf                []*JsSchema          `json:"oneOf,omitempty"`                // section 5.24
	Not                  *JsSchema            `json:"not,omitempty"`                  // section 5.25
	...
	Media          *JsSchema `json:"media,omitempty"`          // section 4.3
